...
Conversion &Conversion::operator=( const Conversion &rhs)
{
	...
	this->nan_flag = rhs.nan_flag;
	this->flag_point = rhs.flag_point;
	this->flag_char_minis = rhs.flag_char_minis;
	this->flag_non_disp = rhs.flag_non_disp;
	this->i_result = rhs.i_result;
	this->d_result = rhs.d_result;
	this->f_result = rhs.f_result;
	this->c_result = rhs.c_result;
	return(*this);
}

char Conversion::to_char(void)
{
...
float  Conversion::to_float(void)
{
